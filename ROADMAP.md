...
and prices its cost at ~1× where a real solute pays 11–20×. The measurement that
would decide the default is fixed-h error on a protein against a reference, and
it has not been run.
